                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <form action="{{url('admin/medicines/add')}}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="row mb-3">
                                <label class="col-sm-2 col-form-lable">Packing </label>
                                <div class="col-sm-10">
                            ...
                            <div class="row mb-3">
                                <label class="col-sm-2 col-form-lable">Generic Name </label>
                                <div class="col-sm-10">
                                    <input type="text" name="generic_name" class="form-control" placeholder="Enter Doctor Generic Name" >
                                </div>
                            </div>
